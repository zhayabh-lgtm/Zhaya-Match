...
export function normalizeProductType(raw: any): ProductType {
  ...
  return {
    ...
    fitType: raw?.fitType || raw?.fit_type || null,
    ...
    measurementImageUrl: raw?.measurementImageUrl || raw?.measurement_image_url || null,
    measurementImageCaption: raw?.measurementImageCaption || raw?.measurement_image_caption || null,
    measurementGuideTips: tips,
    measurementGuideObservation: (rawObs !== null && rawObs !== undefined && String(rawObs).trim() !== '') ? String(rawObs) : null,
