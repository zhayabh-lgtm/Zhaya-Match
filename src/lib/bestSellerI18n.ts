...
const ORGANIZED_PACKS: Record<string, BestSellerOrganizedUiText> = {
  ...
  de: { organizedTitle: 'Was suchst du?', organizedSubtitle: 'Entdecke diese Auswahl nach Kategorie.', organizedAll: 'Alle anzeigen', organizedProducts: '{count} Produkte', organizedContinue: 'Weiter entdecken', organizedBack: 'Kategorie wechseln' },
  ar: { organizedTitle: 'عمّ تبحث؟', organizedSubtitle: 'استكشف هذه المجموعة حسب الفئة.', organizedAll: 'عرض الكل', organizedProducts: '{count} منتجات', organizedContinue: 'متابعة الاستكشاف', organizedBack: 'تغيير الفئة' },
  ...
  'zh-Hans': { organizedTitle: '你在找什么？', organizedSubtitle: '按分类浏览精选商品。', organizedAll: '查看全部', organizedProducts: '{count} 件商品', organizedContinue: '继续浏览', organizedBack: '更换类别' },
  'zh-Hant': { organizedTitle: '你在找什麼？', organizedSubtitle: '依分類瀏覽精選商品。', organizedAll: '查看全部', organizedProducts: '{count} 件商品', organizedContinue: '繼續瀏覽', organizedBack: '更換類別' },
  ko: { organizedTitle: '무엇을 찾고 계신가요?', organizedSubtitle: '카테고리별로 이 셀렉션을 둘러보세요.', organizedAll: '전체 보기', organizedProducts: '상품 {count}개', organizedContinue: '계속 둘러보기', organizedBack: '카테고리 변경' },
  ...
  th: { organizedTitle: 'คุณกำลังมองหาอะไร?', organizedSubtitle: 'สำรวจรายการที่คัดสรรตามหมวดหมู่', organizedAll: 'ดูทั้งหมด', organizedProducts: '{count} สินค้า', organizedContinue: 'เลือกดูต่อ', organizedBack: 'เปลี่ยนหมวดหมู่' },
  ...
  vi: { organizedTitle: 'Bạn đang tìm gì?', organizedSubtitle: 'Khám phá bộ sưu tập này theo danh mục.', organizedAll: 'Xem tất cả', organizedProducts: '{count} sản phẩm', organizedContinue: 'Tiếp tục khám phá', organizedBack: 'Đổi danh mục' },
};
