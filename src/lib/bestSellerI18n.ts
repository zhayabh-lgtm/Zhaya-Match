...
const ORGANIZED_PACKS: Record<string, BestSellerOrganizedUiText> = {
  pt: { organizedTitle: 'Escolha uma categoria', organizedSubtitle: '', organizedAll: 'Ver tudo', organizedProducts: '{count} produtos', organizedContinue: 'Continuar explorando', organizedBack: 'Trocar categoria' },
  en: { organizedTitle: 'Choose a category', organizedSubtitle: '', organizedAll: 'View all', organizedProducts: '{count} products', organizedContinue: 'Keep exploring', organizedBack: 'Change category' },
  es: { organizedTitle: 'Elige una categoría', organizedSubtitle: '', organizedAll: 'Ver todo', organizedProducts: '{count} productos', organizedContinue: 'Seguir explorando', organizedBack: 'Cambiar categoría' },
  de: { organizedTitle: 'Kategorie auswählen', organizedSubtitle: '', organizedAll: 'Alle anzeigen', organizedProducts: '{count} Produkte', organizedContinue: 'Weiter entdecken', organizedBack: 'Kategorie wechseln' },
  ar: { organizedTitle: 'اختر فئة', organizedSubtitle: '', organizedAll: 'عرض الكل', organizedProducts: '{count} منتجات', organizedContinue: 'متابعة الاستكشاف', organizedBack: 'تغيير الفئة' },
  fr: { organizedTitle: 'Choisissez une catégorie', organizedSubtitle: '', organizedAll: 'Tout voir', organizedProducts: '{count} produits', organizedContinue: 'Continuer à explorer', organizedBack: 'Changer de catégorie' },
  'zh-Hans': { organizedTitle: '选择分类', organizedSubtitle: '', organizedAll: '查看全部', organizedProducts: '{count} 件商品', organizedContinue: '继续浏览', organizedBack: '更换类别' },
  'zh-Hant': { organizedTitle: '選擇分類', organizedSubtitle: '', organizedAll: '查看全部', organizedProducts: '{count} 件商品', organizedContinue: '繼續瀏覽', organizedBack: '更換類別' },
  ko: { organizedTitle: '카테고리를 선택하세요', organizedSubtitle: '', organizedAll: '전체 보기', organizedProducts: '상품 {count}개', organizedContinue: '계속 둘러보기', organizedBack: '카테고리 변경' },
  da: { organizedTitle: 'Vælg en kategori', organizedSubtitle: '', organizedAll: 'Se alle', organizedProducts: '{count} produkter', organizedContinue: 'Fortsæt med at udforske', organizedBack: 'Skift kategori' },
  fi: { organizedTitle: 'Valitse kategoria', organizedSubtitle: '', organizedAll: 'Näytä kaikki', organizedProducts: '{count} tuotetta', organizedContinue: 'Jatka selaamista', organizedBack: 'Vaihda kategoriaa' },
  hi: { organizedTitle: 'एक श्रेणी चुनें', organizedSubtitle: '', organizedAll: 'सभी देखें', organizedProducts: '{count} उत्पाद', organizedContinue: 'और देखें', organizedBack: 'श्रेणी बदलें' },
  nl: { organizedTitle: 'Kies een categorie', organizedSubtitle: '', organizedAll: 'Alles bekijken', organizedProducts: '{count} producten', organizedContinue: 'Verder ontdekken', organizedBack: 'Categorie wijzigen' },
  id: { organizedTitle: 'Pilih kategori', organizedSubtitle: '', organizedAll: 'Lihat semua', organizedProducts: '{count} produk', organizedContinue: 'Lanjut jelajahi', organizedBack: 'Ganti kategori' },
  it: { organizedTitle: 'Scegli una categoria', organizedSubtitle: '', organizedAll: 'Vedi tutto', organizedProducts: '{count} prodotti', organizedContinue: 'Continua a esplorare', organizedBack: 'Cambia categoria' },
  ja: { organizedTitle: 'カテゴリーを選択', organizedSubtitle: '', organizedAll: 'すべて見る', organizedProducts: '{count} 商品', organizedContinue: 'さらに見る', organizedBack: 'カテゴリーを変更' },
  ms: { organizedTitle: 'Pilih kategori', organizedSubtitle: '', organizedAll: 'Lihat semua', organizedProducts: '{count} produk', organizedContinue: 'Terus meneroka', organizedBack: 'Tukar kategori' },
  no: { organizedTitle: 'Velg en kategori', organizedSubtitle: '', organizedAll: 'Se alle', organizedProducts: '{count} produkter', organizedContinue: 'Fortsett å utforske', organizedBack: 'Bytt kategori' },
  pl: { organizedTitle: 'Wybierz kategorię', organizedSubtitle: '', organizedAll: 'Zobacz wszystko', organizedProducts: '{count} produktów', organizedContinue: 'Przeglądaj dalej', organizedBack: 'Zmień kategorię' },
  sv: { organizedTitle: 'Välj en kategori', organizedSubtitle: '', organizedAll: 'Visa alla', organizedProducts: '{count} produkter', organizedContinue: 'Fortsätt utforska', organizedBack: 'Byt kategori' },
  th: { organizedTitle: 'เลือกหมวดหมู่', organizedSubtitle: '', organizedAll: 'ดูทั้งหมด', organizedProducts: '{count} สินค้า', organizedContinue: 'เลือกดูต่อ', organizedBack: 'เปลี่ยนหมวดหมู่' },
  tr: { organizedTitle: 'Kategori seçin', organizedSubtitle: '', organizedAll: 'Tümünü gör', organizedProducts: '{count} ürün', organizedContinue: 'Keşfetmeye devam et', organizedBack: 'Kategoriyi değiştir' },
  vi: { organizedTitle: 'Chọn danh mục', organizedSubtitle: '', organizedAll: 'Xem tất cả', organizedProducts: '{count} sản phẩm', organizedContinue: 'Tiếp tục khám phá', organizedBack: 'Đổi danh mục' },
};
