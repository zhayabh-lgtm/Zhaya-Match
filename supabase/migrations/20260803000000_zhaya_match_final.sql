-- ==============================================================================
-- ZHAYA MATCH - SCHEMA FINAL E COMPLETO PARA O SUPABASE SQL EDITOR
-- Arquivo Idempotente (Execução Única e Segura)
-- ==============================================================================

-- 1. Limpeza de tabelas legadas/antigas (se existirem)
...
-- Políticas de Leitura Pública (Widget na Loja e Visitantes)
DO $$
BEGIN
...
-- Políticas de Modificação/Escrita (Somente Usuário Administrador Autenticado)
DO $$
BEGIN
...
INSERT INTO popup_settings (settings, version)
SELECT '{
  "showLogo": true,
  "logoSize": 24,
  "logoPosition": "center",
...
INSERT INTO text_settings (settings)
SELECT '{
  "buttonText": "Descubra seu tamanho",
...
WHERE NOT EXISTS (SELECT 1 FROM text_settings);
...
-- Inserir Configuração Geral do App (Com Domínios Padrão da Zhaya)
INSERT INTO app_settings (enabled, test_mode, allowed_domains, version, widget_url)
